...
[IFNDEF] ALT_KEY2_UP
 0x198 CONSTANT ALT_KEY2_UP
 0x180 CONSTANT ALT_KEY2_DOWN
 0x19D CONSTANT ALT_KEY2_RIGHT
 0x19B CONSTANT ALT_KEY2_LEFT
[THEN]
...
\- MROWS    0x19 CONSTANT MROWS

0 VALUE H_SCROLLING

: MCOLS MAXCURX 1+  H_SCROLLING + ;

\ 40 ' MCOLS >BODY ! 24 ' MROWS >BODY !
\ 0x4E ' MCOLS >BODY ! 0x17 ' MROWS >BODY !
...
1 4 LSHIFT CONSTANT SIZE#ED_FN
...
:  MOCK_EMIT ( c -- )
\ DROP  CUR@_V 1+   MCOLS /MOD VVVSETXY_V
...
\  VVVGETXY
 ...
 BETWEEN
  ...
  DUP CLIPBOARD LCOUNT + C!  CLIPBOARD 1+!
...
\		VVVGETXY_V DROP MAXCURX U> OR  \  DUP IF 1 EMIT THEN
         UNTIL
        ELSE  VVVEMIT
        THEN ;
...
\  COLOR-SET
 ...
 VVVGETXY DROP MCOLS 1-  U< 0=  MOCK_FLG 0= AND
  ...
  EMITTAB
 		...
 		VVVGETXY_V DROP 0=  TO VIEW-EMIT-END
  ;
...
\       VIEW-X @ VVVGETXY DROP -  X_OFFSET3 + TO X_OFFSET4
  THEN
  MOCK_FLG IF
\  VIEW0-Y 1+!  VIEW0-X 0! 
 ...
 BREAK
  ...
  MCOLS  VVVGETXY DROP -
\ DUP 1 <>  IF  SPACES ELSE DROP CR THEN
 SPACES_ED
...
: VIEWFILEREAD ( -- flg )
  ...
  DUTYFILENAME COUNT
  R/O OPEN-FILE 
  IF  CR ." do you wish to create"  DUTYFILENAME COUNT TYPE ."  file? Y/N" 
	KEY 0x20 OR 'y' <> IF -1 BREAK
	DUTYFILENAME COUNT W/O CREATE-FILE THROW
  THEN
  TO VIEWFID
  VIEW_BUF VIEW-SIZE VIEWFID  READ-FILE DROP VIEW-MAX-POINT !
  0 TO FILECHANGED?
...
[THEN]
 ...
 CTRL_KEY2_PAGE_UP	OF VIEW-#Y0 0! VIEW-PAGE1 VIEW-Y 0!
			ENDOF
 CTRL_KEY2_HOME		OF VIEW-#Y0 0! VIEW-PAGE1 VIEW-Y 0!
			ENDOF
	$19	OF \ CTRL Y
			CUR_LINE
			2DUP XOR
...
\	GETXY 2>R 0 MAXCURY 3 - SETXY \ cr ." e="
...
\			UNDO_S_BUF 2+ UNDO_S_BUF UNDO_S_SIZE CMOVE			
	...
	ALT_KEY2_DOWN	OF NEW_BLK_ED VIEW-Y @ 1+ DUP VIEW-Y ! 1+ YBLOCK-END ! VIEW-PAGE ENDOF
	ALT_KEY2_UP	OF NEW_BLK_ED VIEW-Y @ 1- DUP VIEW-Y ! 1+ YBLOCK-END ! VIEW-PAGE ENDOF
	ALT_KEY2_RIGHT	OF NEW_BLK_ED VIEW-X @ 1+ DUP VIEW-X ! H_SCROLLING - XBLOCK-END ! VIEW-PAGE ENDOF
	ALT_KEY2_LEFT	OF NEW_BLK_ED VIEW-X @ 1- DUP VIEW-X ! H_SCROLLING - XBLOCK-END ! VIEW-PAGE ENDOF
